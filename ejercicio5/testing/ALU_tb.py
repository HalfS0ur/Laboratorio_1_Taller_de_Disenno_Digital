...
async def test_XOR(dut):
    ...
    for valor_a in range (RANGO):
        ...
        for valor_b in range (RANGO):
            dut.ALUB.value = valor_b
            await Timer(1, 'ns')
            assert dut.ALUResult.value == valor_a ^ valor_b, f"ALU output ALUResult was incorrect. Got {dut.ALUResult.value}, expected {(valor_a ^ valor_b)}"
...
async def test_corrimiento_izquierda_ceros(dut):
    ...
    for valor_a in range (RANGO):
        ...
        for valor_b in range (RANGO):
            ...
            await Timer(1, 'ns')
            assert dut.ALUResult.value == resultado
...
async def test_corrimiento_izquierda_unos(dut):
    ...
    for valor_a in range (RANGO):
        ...
        for valor_b in range (RANGO):
            ...
            await Timer(1, 'ns')
            assert dut.ALUResult.value == resultado_esperado
